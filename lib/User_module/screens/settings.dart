...
class _SettingsPageState extends State<SettingsPage> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            AccountOption(context, "Social"),
            AccountOption(context, "Language"),
            AccountOption(context, "Privacy and security"),
            SizedBox(
              height: 40,
            ),
            Row(
            ...
            NotificationOption("New for you", true),
            NotificationOption("Account activity", true),
            NotificationOption("Opportunity", false),
            SizedBox(
              height: 50,
            ),
            Center(
  ...
  Row NotificationOption(String title, bool isActive) {
    return Row(
